- Arcade
- Вы играете за Робин гуда, ваша задача избегать монстров и спасти принцессу
- Скачайте папку с файлами и изображениями из гитхаба
- Запустите файл с расширением "py" и играйте
- '''python
...
while run:
  ...
  '''
- Какие-то челы, может преподаватель
- [ЛИЦЕНЗИЯ](https://vk.com/elwinner)
- Ссылка на вк: https://vk.com/mistercat100
